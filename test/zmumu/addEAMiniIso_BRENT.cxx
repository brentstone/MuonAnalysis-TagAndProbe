...
void addEAMiniIso_BRENT() {
    ...
    Float_t pfCombRelMiniIsoEACorr;
    ...
    for (int i = 0, n = tIn->GetEntries(); i < n; ++i) {
        ...
        pfCombRelMiniIsoEACorr = (chHad + max(0.0, phot + nHad - rho * ea_tot * pow((10.0/min(max((double) pt, 50.),200.))/0.3,2)))/pt;
